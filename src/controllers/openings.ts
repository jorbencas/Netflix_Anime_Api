    ...
    const getOpeningsbyAnimes = (req: Request, res: Response) => {
        $db = $api->getDb();
        $GET = $api->getGET();
    ...
    const getOneopening = (req: Request, res: Response) => {
        $db = $api->getDb();
        $GET = $api->getGET();
    ...
    const inserteditOneopening = (req: Request, res: Response) => {
        $db = $api->getDb();
        $POST = $api->getPOST();
    ...
    const deleteOneopening = (req: Request, res: Response) => {
        $db = $api->getDb();
        $POST = $api->getPOST();
    ...
    const deleteOpeningsbyanime = (req: Request, res: Response) => {
        $db = $api->getDb();
        $POST = $api->getPOST();
