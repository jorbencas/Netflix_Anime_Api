 const Endings = (req: Request, res: Response) => {
        $GET = $api->getGET();
        switch ($api->getAction()) {
            ...
            case 'query': $result = const_exists($GET['aq']) ? $GET['aq']($api) : $api->response("api_Endings_resp_error_msg", 404); break;
            default: $result = $api->response("api_Endings_resp_error_msg", 404);  break;
        }
        return $result;
    }

    const getEndingsbyAnime = (req: Request, res: Response) => {
        $GET = $api->getGET();
        $db = $api->getDb();
    ...
    const getOnending = (req: Request, res: Response) => {
        $db = $api->getDb();
        $GET = $api->getGET();
    ...
    const inserteditOneending = (req: Request, res: Response) => {
        $db = $api->getDb();
        $POST = $api->getPOST();
    ...
    const deleteOneending = (req: Request, res: Response) => {
        $db = $api->getDb();
        $POST = $api->getPOST();
    ...
    const deleteEndingsbyanime = (req: Request, res: Response) => {
        $db = $api->getDb();
        $POST = $api->getPOST();
