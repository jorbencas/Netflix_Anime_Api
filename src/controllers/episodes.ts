...
import { Request, Response } from 'express';
    ...
    const getLastepisodes = (req: Request, res: Response) => {
        $GET = $api->getGET();
        $db = $api->getDb();
    ...
    const inserteditOneepisode = (req: Request, res: Response) => {
        $POST = $api->getPOST();
        $db = $api->getDb();
    ...
    const deleteOneepisode = (req: Request, res: Response) => {
        $POST = $api->getPOST();
        $db = $api->getDb();
    ...
    const deleteEpisodesbyanime = (req: Request, res: Response) => {
        $POST = $api->getPOST();
        $db = $api->getDb();
