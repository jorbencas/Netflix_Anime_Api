...
*/
  ...
  //   alias mount_media='sudo mount --bind $link $destination'
  //   alias umount_media='sudo umount $destination'
  //   alias run_anime_client='cd ~/Documentos/Netflix_Anime/react-api/ && npm start'
  //   alias run_anime_node='cd /var/www/Netflix_Anime_Api/node/ && npm start'
  //   alias generate_public_private_key='ssh-keygen -t rsa'" >> "~/.bash_aliases"
...
// docker exec -it odoo_clean_db /bin/bash
  ...
  //   #PHP7.4
  //   sudo apt install php7.4 libapache2-mod-php7.4 php7.4-mysql php-common php7.4-cli php7.4-common php7.4-json php7.4-opcache php7.4-readline php7.4-curl php7.4-pgsql
  //   sudo a2enmod php7.4
  ...
  //     anime int4 NOT NULL,
  //     epistart int4 DEFAULT 0,
  //     epiend int4 DEFAULT 0,
  //     created timestamp DEFAULT CURRENT_TIMESTAMP,
  //     updated timestamp DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
  //   );";
  // $db->ejecutar($sql);
